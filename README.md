...
| 4    | Alta       | No PowerBi, montar um template de dashboard para que seja possivel decidir qual visual será definido para o projeto.                                | 1      |
...
| 11   | Alta       | Na PowerBi, Adicionar a Média do Valor FOB por produto.                                                                                             | 2      |
